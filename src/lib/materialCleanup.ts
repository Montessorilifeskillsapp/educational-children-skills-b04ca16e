...
const ALIASES: Record<string, string> = {
  ...
  'black and white bead stair': 'Black and white bead stair',
  'colored bead bars': 'Colored bead stair (1–9)',
  'coloured bead bars': 'Colored bead stair (1–9)',
  'colored bead stair': 'Colored bead stair (1–9)',
  'colored bead stair (1-9)': 'Colored bead stair (1–9)',
  'gray bead bars': 'Gray bead stair',
  'gray bead bars (subtrahends)': 'Gray bead stair',
  'grey bead bars': 'Gray bead stair',
  'grey bead bars (subtrahends)': 'Gray bead stair',
  'gray bead bars 1-9': 'Gray bead stair',
  'gray bead stair': 'Gray bead stair',
  'gray bead stair (1-9)': 'Gray bead stair',
  'negative bead bars': 'Gray bead stair',
  'blue strips': 'Blue strips (1–9)',
  'blue strips (1-9)': 'Blue strips (1–9)',
  'red strips': 'Red strips (1–9)',
  'red strips (1-9)': 'Red strips (1–9)',
  'wooden strips': 'Natural wooden strips (1–18)',
  'natural wooden strips': 'Natural wooden strips (1–18)',
  'natural wooden strips (1-18)': 'Natural wooden strips (1–18)',
  'notched card': 'Notched card (bridge)',
  'bridge card': 'Notched card (bridge)',
  'notched card (bridge)': 'Notched card (bridge)',
