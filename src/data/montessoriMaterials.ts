...
export const montessoriMaterials: MontessoriMaterial[] = [
  ...
  // Additional Mathematics Materials
  {
    ...
    description: 'Board with numbered red and blue strips 1–9 for addition facts',
    ageRange: '4-6 years',
    skillLevel: 'Advanced',
    inStock: true,
    rating: 4.6
  },
  {
    ...
    category: 'Mathematics',
    subcategory: 'Operations',
    description: 'Board with natural wooden minuend strips and blue strips 1–9 for subtraction facts',
    ageRange: '4-6 years',
    skillLevel: 'Advanced',
    inStock: true,
    rating: 4.5
  ...
  },
  {
    ...
    category: 'Mathematics',
    subcategory: 'Operations',
    description: 'Colored bead stair, golden ten bars and black and white bead stair for addition',
    ageRange: '4-6 years',
    skillLevel: 'Advanced',
    inStock: true,
    rating: 4.8
