  ...
  'hand-washing': {
    ...
    learningProcess: {
      presentation: {
        ...
        steps: [
          'I put on apron (optional, if used for water works)',
          'I roll up sleeves neatly to keep dry',
          'I fill pitcher with water from a designated source',
          'I pour water into the basin slowly, with control',
          'I wet hands in the basin gently',
          'I pick up the soap and rub it between both hands until a lather forms',
          'I scrub all parts of the hands — palms, backs, between fingers, wrists',
          'I use nail brush and rinse it afterward (optional)',
          'I rinse hands in the basin thoroughly',
          'I dry hands completely with a towel, starting at the fingertips and moving toward the wrists',
          'I hang the towel back up or place it in the laundry basket if it\'s dirty',
          'I empty the basin into a bucket or designated area',
          'I rinse the basin and wipe the area dry with a sponge if there were spills',
          'I return all materials to their proper places, neatly',
          'I remove apron and hang it up'
        ],
        keyPoints: [
